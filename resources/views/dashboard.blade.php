...
<head>
    ...
    <!-- Simplebar -->
    <link rel="stylesheet" href="{{ asset('admin-asset/vendor/simplebar.min.css') }}">

    <!-- App CSS -->
    <link rel="stylesheet" href="{{ asset('admin-asset/css/app.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-asset/css/app.rtl.css') }}">

    <!-- Material Design Icons -->
    <link rel="stylesheet" href="{{ asset('admin-asset/css/vendor-material-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-asset/css/vendor-material-icons.rtl.css') }}">

    <!-- Font Awesome FREE Icons -->
    <link rel="stylesheet" href="{{ asset('admin-asset/css/vendor-fontawesome-free.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-asset/css/vendor-fontawesome-free.rtl.css') }}">
  ...
  fbq('track', 'PageView');
    ...
    <!-- Flatpickr -->
    <link rel="stylesheet" href="{{ asset('admin-asset/css/vendor-flatpickr.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-asset/css/vendor-flatpickr.rtl.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-asset/css/vendor-flatpickr-airbnb.css') }}">
    <link rel="stylesheet" href="{{ asset('admin-asset/css/vendor-flatpickr-airbnb.rtl.css') }}">

    <!-- Vector Maps -->
    <link rel="stylesheet" href="{{ asset('admin-asset/vendor/jqvmap/jqvmap.min.css') }}">
...
<body class="layout-default">
    ...
    <!-- jQuery -->
    <script src="{{ asset('admin-asset/vendor/jquery.min.js') }}"></script>

    <!-- Bootstrap -->
    <script src="{{ asset('admin-asset/vendor/popper.min.js') }}"></script>
    <script src="{{ asset('admin-asset/vendor/bootstrap.min.js') }}"></script>

    <!-- Simplebar -->
    <script src="{{ asset('admin-asset/vendor/simplebar.min.js') }}"></script>

    <!-- DOM Factory -->
    <script src="{{ asset('admin-asset/vendor/dom-factory.js') }}"></script>

    <!-- MDK -->
    <script src="{{ asset('admin-asset/vendor/material-design-kit.js') }}"></script>

    <!-- App -->
    <script src="{{ asset('admin-asset/js/toggle-check-all.js') }}"></script>
    <script src="{{ asset('admin-asset/js/check-selected-row.js') }}"></script>
    <script src="{{ asset('admin-asset/js/dropdown.js') }}"></script>
    <script src="{{ asset('admin-asset/js/sidebar-mini.js') }}"></script>
    <script src="{{ asset('admin-asset/js/app.js') }}"></script>

    <!-- App Settings (safe to remove) -->
    <script src="{{ asset('admin-asset/js/app-settings.js') }}"></script>



    <!-- Flatpickr -->
    <script src="{{ asset('admin-asset/vendor/flatpickr/flatpickr.min.js') }}"></script>
    <script src="{{ asset('admin-asset/js/flatpickr.js') }}"></script>

    <!-- Global Settings -->
    <script src="{{ asset('admin-asset/js/settings.js') }}"></script>

    <!-- Chart.js -->
    <script src="{{ asset('admin-asset/vendor/Chart.min.js') }}"></script>

    <!-- App Charts JS -->
    <script src="{{ asset('admin-asset/js/charts.js') }}"></script>

    <!-- Chart Samples -->
    <script src="{{ asset('admin-asset/js/page.dashboard.js') }}"></script>

    <!-- Vector Maps -->
    <script src="{{ asset('admin-asset/vendor/jqvmap/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('admin-asset/vendor/jqvmap/maps/jquery.vmap.world.js') }}"></script>
    <script src="{{ asset('admin-asset/js/vector-maps.js') }}"></script>
